...
if (!values.terms) {
  toast({
    title: "Terms Required",
    description:
      "Please accept the Terms & Privacy Policy before creating an account.",
    variant: "warning",
  });
  ...
  try {
    ...
    await registerUser({
      ...
      // Every new account becomes a member
      role: "member",
    });
            ...
            <div className="flex items-center gap-2">
              <motion.div
                animate={{
                  scale: active ? 1.08 : 1,
                  backgroundColor:
                    done || active ? "#19376D" : "#E7E0D7",
                  color:
                    done || active ? "#fff" : "#6B7280",
                }}
